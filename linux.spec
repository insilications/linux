...
BuildKernel() {
    ...
    unset CXXFLAGS
    unset LDFLAGS
    export CFLAGS="-O2 -march=skylake -mtune=skylake -Wl,-O2 -falign-functions=32 -mprefer-vector-width=256 -fuse-ld=bfd -fno-semantic-interposition -fno-stack-protector -malign-data=cacheline -pipe"
    export KCFLAGS="-O2 -march=skylake -mtune=skylake -Wl,-O2 -falign-functions=32 -mprefer-vector-width=256 -fuse-ld=bfd -fno-semantic-interposition -fno-stack-protector -malign-data=cacheline -pipe"
    ...
    make O=${Target} -s ARCH=${Arch} V=2 KCFLAGS="-O2 -march=skylake -mtune=skylake -Wl,-O2 -falign-functions=32 -mprefer-vector-width=256 -fuse-ld=bfd -fno-semantic-interposition -fno-stack-protector -malign-data=cacheline -pipe" CONFIG_DEBUG_SECTION_MISMATCH=y -j16
}
