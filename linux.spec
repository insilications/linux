...
BuildKernel() {
    ...
    make O=${Target} -s ARCH=${Arch} V=1 VERBOSE=1 KCFLAGS="-O2 -march=native -Wl,-O2 -falign-functions=32 -flimit-function-alignment -fdevirtualize-at-ltrans -fgraphite-identity -floop-nest-optimize -floop-block -ftree-loop-distribute-patterns -fno-tree-vectorize -fuse-ld=bfd -fno-math-errno -fno-trapping-math -fno-semantic-interposition -fno-stack-protector -malign-data=cacheline -fipa-pta --param=max-isl-operations=0 -pipe" CONFIG_DEBUG_SECTION_MISMATCH=y %{?_smp_mflags} %{?sparse_mflags}
}
...
InstallKernel() {
    ...
    unset CXXFLAGS
    unset LDFLAGS
    export CFLAGS="-O2 -march=native -Wl,-O2 -falign-functions=32 -flimit-function-alignment -fdevirtualize-at-ltrans -fgraphite-identity -floop-nest-optimize -floop-block -ftree-loop-distribute-patterns -fno-tree-vectorize -fuse-ld=bfd -fno-math-errno -fno-trapping-math -fno-semantic-interposition -fno-stack-protector -malign-data=cacheline -fipa-pta --param=max-isl-operations=0 -pipe"
    Target=$1
    Kversion=$2
    Arch=x86_64
    ...
    make O=${Target} ARCH=${Arch} INSTALL_MOD_PATH=%{buildroot}/usr V=1 VERBOSE=1 KCFLAGS="-O2 -march=native -Wl,-O2 -falign-functions=32 -flimit-function-alignment -fdevirtualize-at-ltrans -fgraphite-identity -floop-nest-optimize -floop-block -ftree-loop-distribute-patterns -fno-tree-vectorize -fuse-ld=bfd -fno-math-errno -fno-trapping-math -fno-semantic-interposition -fno-stack-protector -malign-data=cacheline -fipa-pta --param=max-isl-operations=0 -pipe" %{?_smp_mflags} modules_install

    make O=${Target} ARCH=${Arch} prefix=/usr WERROR=0 DESTDIR=%{buildroot} mandir=/usr/share/man PYTHON=/usr/bin/python3 PYTHON_CONFIG=/usr/bin/python3-config V=1 VERBOSE=1 KCFLAGS="-O2 -march=native -Wl,-O2 -falign-functions=32 -flimit-function-alignment -fdevirtualize-at-ltrans -fgraphite-identity -floop-nest-optimize -floop-block -ftree-loop-distribute-patterns -fno-tree-vectorize -fuse-ld=bfd -fno-math-errno -fno-trapping-math -fno-semantic-interposition -fno-stack-protector -malign-data=cacheline -fipa-pta --param=max-isl-operations=0 -pipe" CFLAGS+="-O2 -march=native -Wl,-O2 -falign-functions=32 -flimit-function-alignment -fdevirtualize-at-ltrans -fgraphite-identity -floop-nest-optimize -floop-block -ftree-loop-distribute-patterns -fno-tree-vectorize -fuse-ld=bfd -fno-math-errno -fno-trapping-math -fno-semantic-interposition -fno-stack-protector -malign-data=cacheline -fipa-pta --param=max-isl-operations=0 -pipe" CXXFLAGS+="-O2 -march=native -Wl,-O2 -falign-functions=32 -flimit-function-alignment -fdevirtualize-at-ltrans -fgraphite-identity -floop-nest-optimize -floop-block -ftree-loop-distribute-patterns -fno-tree-vectorize -fuse-ld=bfd -fno-math-errno -fno-trapping-math -fno-semantic-interposition -fno-stack-protector -malign-data=cacheline -fipa-pta --param=max-isl-operations=0 -pipe" -j1 tools/acpi tools/acpi_install || :
